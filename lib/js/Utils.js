 ...
 * store local token
 */
const storeLocalToken = (token, refreshToken) => {
 ...
 * @param {*} extraData 
 */
const uploadFile = (url, filePath, extraData, name) => {
    return new Promise(function (resolve, reject) {
        wx.uploadFile({
            url: `${__config.apiBasePath}${url}`,
            name: name,
            header: {
